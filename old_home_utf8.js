...
export function HomeScreen({ openSettings }) {
  ...
  // Funci├│n inc├│gnito ÔÇö cubre todos los montos
  const hidden = (val) => incognito ? "ÔÇóÔÇóÔÇóÔÇóÔÇóÔÇó" : val;
    ...
    <View style={{ flex:1, backgroundColor: TH.bg }}>
      <SafeAreaView style={{ flex:1 }}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom:130 }}>
            ...
            <FadeIn delay={90}>
              <View style={{ marginHorizontal:16, marginBottom:12, borderRadius:14, backgroundColor:TH.roseBg2,
                ...
                <View style={{ flex:1 }}>
                  ...
                  <Text style={{ fontSize:11, color:TH.t3, marginTop:2 }}>Ocio bloqueado ┬À {frenoState.hoursLeft}h restantes</Text>
                </View>
              </View>
            </FadeIn>
          )}
              ...
              {expenses.length === 0 ? (
                <View style={{ paddingVertical:8 }}>
                  ...
                  <View style={{ alignItems:"center" }}>
                    <Text style={{ fontSize:13, fontWeight:"900", color:TH.mint }}>Tu potencial de ahorro aqu├¡</Text>
                    ...
                    <View key={e.id}>
                      <View style={{ flexDirection:"row", alignItems:"center", gap:12 }}>
                        ...
                        <View style={{ flex:1 }}>
                          ...
                          <Text style={{ fontSize:10, color:TH.t3, marginTop:1 }}>{e.cat} ┬À {e.date}</Text>
                        </View>
            ...
            <FadeIn delay={190}>
              <Card style={{ marginBottom:12 }}>
                <View style={{ flexDirection:"row", justifyContent:"space-between", marginBottom:14 }}>
                  <Text style={{ fontSize:14, fontWeight:"800", color:TH.t1 }}>Por Categor├¡a</Text>
          ...
          {/* Banner publicitario ÔÇö solo usuarios gratuitos */}
